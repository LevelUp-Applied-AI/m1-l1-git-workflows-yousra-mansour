...
This project analyzes hospital admission records for a regional health authority. The goal is to identify trends in patient admissions and better understand hospital resource usage using Python data analysis tools.
